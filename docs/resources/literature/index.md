...
This section is meant to provide summaries of some foundational literature and toolkits for community archiving. 
...
Looking beyond institutional archives and into the private homes of Black women, Sutton offers Descendant Archival Practices, a method for researching the archives that Black women maintained in the 19th and 20th centuries. By studying these home-based archives, which compile oral histories, documents, and artifacts, Sutton addresses the misconception that Black histories are lost to time, holding historians accountable for not investigating gaps in institutional archives. 

**Sutton, Jazma & Kalani Craig.** “Reaping the Harvest: Descendant Archival Practice to Foster Sustainable Digital Archives for Rural Black Women.” Digital Humanities 	Quarterly, vol. 16, no. 3, 	2022. [http://www.digitalhumanities.org/dhq/vol/16/3/000640/000640.html](http://www.digitalhumanities.org/dhq/vol/16/3/000640/000640.html) 

Sutton and Craig draw attention to the ethical concerns of transferring analog archives to a digital platform, and how the mixed-media Descendant Archival Practices methodology ensures that Black histories are digitally preserved in this transfer, too. Demonstrating the method in action from previous history harvests, Sutton and Craig honor Black women as the ancestral custodians of Black histories and underscore the importance of intergenerational collaboration in moving their historical materials online.

**Drake, Jarrett M.** “#ArchivesForBlackLives: Building a Community Archives of Police Violence in Cleveland.” Medium, 22 April 2016. 

Black archivist Jarrett M. Drake calls archivists to social justice action, with the goal of creating independent archives. After discovering a hole in Twitter’s historical record, Drake developed the platform [http://Archivingpoliceviolence.org](http://Archivingpoliceviolence.org) as a decolonial archive, where witnesses of police violence have shared oral histories. Since historically, archives and institutions of power have operated together, stories about marginalized people exist more reliably when not stored with archival authorities.

**Hughes-Watkins, Lae’l.** “Moving Toward a Reparative Archive: A Roadmap for a Holistic Approach to Disrupting Homogenous Histories in Academic Repositories and Creating Inclusive Spaces for Marginalized Voices.” Journal of Contemporary Archival Studies, vol. 5, no. 1, Jan. 2018, p. 6. [https://digitalcommons.kent.edu/libpubs/269](https://digitalcommons.kent.edu/libpubs/269). 

Hughes-Watkins poses the question of how archives, which conventionally serve entrenched and monolithic narratives, can change their practices in order to serve a reparative role. By “reparative archive,” Hughes-Watkins means a set of practices which serve to reach out to disenfranchised communities and cooperate with them. In particular, she uses Kent State University’s collaboration with black alumni from the Black Campus Movement in order to build a physical and digital exhibit through special collections. In this process, she emphasizes three main ideas: Acquisition of items, Advocacy, and Utilization. 


## Toolkits 

**Johnson, Valencia.** “Archiving Student Activism Toolkit.” Project Stand. [https://standarchives.com/archiving-student-activism-toolkit-3/](https://standarchives.com/archiving-student-activism-toolkit-3/). Accessed May 23,	2025.  

This toolkit, tailored for activists who donate their collections to institutional archives, trains them on how to ensure the best conditions for their donated material. It Johnson’s toolkit gives activists an idea of the considerations they should make ahead of selecting an archive, meeting with archivists, and their right to establish rules for the collection. Likewise, Johnson tells archivists to familiarize themselves with the motives of their institution and determine an ethical mode for acquisition within their institutional framework.  

**Kuo, Rachel, and Lorelei Lee.** “Dis/Organizing: How We Build Collectives Beyond Institutions: A Non-Comprehensive Community Toolkit and Report.” Hacking/Hustling. [https://hackinghustling.org/wp-content/uploads/2021/10/DisorganizingToolkit.pdf](https://hackinghustling.org/wp-content/uploads/2021/10/DisorganizingToolkit.pdf)  

Based on research on and experience with activism, Kuo and Lee offer strategies for resisting the institutionally led disintegrations of political collectives. They define the term "dis/organizing" as "messy on purpose," or strategically disruptive to institutions. The toolkit is crucial to read before developing a political collective of any scale to prepare for how to handle money, resource access, social differences, leadership, and technology—all areas relevant to digital community engagement, too. 

**UCLA Community Archives Lab.** WordPress, 2016, [https://communityarchiveslab.ucla.edu/](https://communityarchiveslab.ucla.edu/). 
...
Writing in both descriptive and poetic language, Dorothy Berry defines the “artificial archive,” a technically impossible global inventory of Black archival material. Her proposed artificial archive accounts for entire people, institutions, anonymous photographs, food, ephemera, social media, and any person’s own idea of what an archive is. It points to the limited scope of things (let alone objects) that a typical institutional archive can physically contain, excluding a world of archival material about Black people. 

**Home Bound.** Community-Archive Jekyll Theme by Kalani Craig, 2023, [https://homeboundatiu.github.io/](https://homeboundatiu.github.io/). Accessed April 18, 2025.  

This online catalogue documents Home Bound, an independently curated, grassroots exhibition featuring 19 works on paper, sculpture, and video by Indiana University students. The digital archiving platform allowed the curator to offer a professional website for artists to include on their resumes as exhibition experience, contributing to an ethics of collaboration. The exhibition was open during the spring of 2023 at the IU Sciences Library. 

**Remembering Freedom: Longtown and Greenville History Harvest.** The Longtown History team and Mediumish Jekyll Theme, 2022, [https://longtownhistory.github.io/](https://longtownhistory.github.io/). 

The descendants of the Greenville Settlement, a rural Black community founded in 1818, use this website to help preserve and share the town’s history. The descendants, who were already active participants in protecting their town’s stories before the history harvest, share oral histories, an online exhibition, and a tour of their Homecoming Event where the history harvest took place. 

**La Casa, La Comunidad.** DigitalArc Jekyll Theme by Kalani Craig, 2025, [https://lacasaiu.github.io/](https://lacasaiu.github.io/). Accessed May 8, 2025. 

Celebrating 50 years at IU in 2023, the cultural center La Casa archived its memories on this DigitalArc website. It features an online collection of photographs, memorabilia, and student-written articles that image its history. A 3D Virtual Walkthrough of La Casa archives the house itself and takes the website user on a written tour around La Casa, demonstrating the many services that the cultural organization provides. Finally, an online catalogue of photographs captures its 50th Anniversary Celebration Banquet.

**Remembering Rondo.** “A Sustainable Shared Authority: The Future of Rondo’s Past.” YouTube, 30 Oct. 2024, [https://www.youtube.com/watch?v=77U5h8Ed46I](https://www.youtube.com/watch?v=77U5h8Ed46I). 
