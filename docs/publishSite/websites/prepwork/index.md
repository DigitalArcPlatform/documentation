...
- If you need more support, visit our [documentation page]({{site.baseurl}}/docs/postEvent/naming/).
...
- You can use voice-to-text options on Google Docs or Microsoft Word to help you generate the transcripts. 
	- If you are using Google Docs, here is [how to activate voice-to-text](https://support.google.com/docs/answer/4492226?hl=en).
	- If you are using Microsoft Word, here is [how to activate voice-to-text](https://support.microsoft.com/en-us/office/transcribe-your-recordings-7fc2efec-245e-45f0-b053-2a97531ecf57)
		- Select the drop down meny "Upload an audio file" 
- If you need more support, visit our [documentation page]({{site.baseurl}}/docs/postEvent/transcription/)
...
If you need more support, visit our [documentation page]({{site.baseurl}}/docs/postEvent/photo/).
...
- Apple
	- [iPhone (Editing)](https://support.apple.com/guide/iphone/edit-photos-and-videos-iphb08064d57/ios)
	- [iPhone (Cropping)](https://support.apple.com/guide/iphone/crop-rotate-flip-straighten-photos-videos-iph0f3ebb1dd/26/ios/26)
	- [MacBook (Editing)](https://support.apple.com/guide/photos/editing-basics-pht304c2ace6/mac)

- Windows/Android
	- [Android (Editing)](https://www.samsung.com/us/support/answer/ANS10003229/)
	- [Android (Cropping)](https://www.samsung.com/au/support/mobile-devices/quick-crop/?srsltid=AfmBOopoEMOvccDGRSrfhYSCh_iqPak23uI_9-jxLn55XpdoglQwEd6o)
	- [Windows (Editing)](https://support.microsoft.com/en-us/windows/edit-photos-and-videos-in-windows-a3a6e711-1b70-250a-93fa-ef99048a2c86)
...
- If you have not yet, copy our [metadata spreadsheet](https://docs.google.com/spreadsheets/d/1H6viuRVnWmd_lhztZM7qOB4xDMjyXVSAhLQMjmWaRUo/edit?usp=sharing) to your Google Drive
...
For more on metadata, see [our documentation]({{site.baseurl}}/docs/postEvent/metadata/#community-conversations-about-object-descriptions ).
