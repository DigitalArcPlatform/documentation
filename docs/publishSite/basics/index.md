...
*If you're not comfortable with GitHub*, skip this 5-step overview and proceed through the individual sections in this "Publishing Your Site" section one by one. each one will provide step-by-step details that break each of the 5 steps here into smaller, more manageable activities.
