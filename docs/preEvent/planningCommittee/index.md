...
2. Outreach Coordinator
  - Manage all promotional content related to the event
  - Communicate with community members to notify them of events and encourage participation
  - Oversee event branding
3. Volunteer Coordinator
  - Recruit volunteers to assist with day-of event needs
  - Organizing training sessions for volunteers ahead of the event
  - Manage volunteer schedule to ensure adequate coverage throughout the event
4. Event Logistics Coordinator
  - Find a suitable venue for the event and be the point of contact for any communication from the venue
  - Collaborate with the Volunteer Coordinator and Lead Organizer to set a schedule of events
  - Identify supplies needed and coordinate gathering items
  - Determine refreshments needed and purchase items
